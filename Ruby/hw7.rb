...
class Intersect < GeometryExpression
  ...
  def eval_prog env
    @e1.eval_prog(Array.new(env)).intersect(@e2.eval_prog(Array.new(env)))
  end
...
class Let < GeometryExpression
  ...
  def eval_prog env
    env1=Array.new(env)
    @e2.eval_prog(env1.unshift([@s, @e1.eval_prog(Array.new(env))]))
  end
...
class Shift < GeometryExpression
  ...
  def eval_prog env
    @e.eval_prog(Array.new(env)).shift(@dx, @dy)
  end
